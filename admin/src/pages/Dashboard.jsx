      ...
      <main className="flex-1 p-4 lg:p-8 overflow-y-auto h-screen relative">
        ...
        <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          ...
          <div className="flex items-center gap-3 sm:gap-5 w-full sm:w-auto">
            ...
            {/* 🔥 NEW: Profile Section (Right next to the bell) */}
            <div className="flex items-center gap-3 pl-2 sm:pl-4 border-l border-slate-200 cursor-pointer group ml-auto sm:ml-0">
              <div className="hidden sm:block text-right">
                <p className="text-sm font-bold text-slate-800 leading-tight group-hover:text-purple-600 transition-colors">Admin User</p>
                <p className="text-[10px] font-semibold text-slate-400">Master Instructor</p>
              </div>
              <div className="w-10 h-10 bg-gradient-to-br from-cyan-50 to-blue-100 rounded-full flex items-center justify-center relative shadow-inner ring-2 ring-transparent group-hover:ring-purple-300 transition-all">
                <span className="text-lg">👨‍💻</span>
                {/* Tiny flame icon to match your theme */}
